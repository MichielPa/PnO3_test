...
import 'CurrentReservationButton.dart';
    ...
    return Scaffold(
      body: Consumer(builder: (context, WidgetRef ref,_) {
        ...
        Future<List> getHistory() async {
          final help = await requestHistory(loginResult!.email, loginResult.token);
      ...
      //floatingActionButton: const CurrentReservationButton()
    );
  }
}